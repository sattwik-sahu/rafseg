...
from utils.vision.seg_gpt.detectron2.utils.registry import _convert_target_to_string
...
class LazyCall:
    ...
    Examples:
    ::
        from utils.vision.seg_gpt.detectron2.config import instantiate, LazyCall
