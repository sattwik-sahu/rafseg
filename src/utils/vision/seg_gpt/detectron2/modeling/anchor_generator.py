...
from utils.vision.seg_gpt.detectron2.layers import ShapeSpec, move_device_like
from utils.vision.seg_gpt.detectron2.structures import Boxes, RotatedBoxes
