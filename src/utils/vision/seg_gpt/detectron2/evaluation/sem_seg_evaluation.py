...
from utils.vision.seg_gpt.detectron2.data import DatasetCatalog, MetadataCatalog
from utils.vision.seg_gpt.detectron2.utils.comm import all_gather, is_main_process, synchronize
